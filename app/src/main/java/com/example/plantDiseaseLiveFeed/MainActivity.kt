package com.example.plantDiseaseLiveFeed
...
import com.example.plantDiseaseLiveFeed.ImageUtils.convertYUV420ToARGB8888
...
//        setFragment()
        ...
        try {
            classifier = Classifier(assets,"plant_disease_model.tflite", "plant_labels.txt",224)
    ...
    var previewHeight = 0;
    var previewWidth = 0
    //fragment which show live footage from camera
